...
from .permutations import make_jigsaw_perm_32, get_inv_perm
from .view_permute import PermuteView
from .jigsaw_helpers import get_jigsaw_pieces

class JigsawView_32(PermuteView):
    '''
    Implements a 32x32 jigsaw puzzle view...
    ...
    def __init__(self, seed=11):
        ...
        self.perm_64 = make_jigsaw_perm_32(64, seed=seed)
        self.perm_256 = make_jigsaw_perm_32(256, seed=seed)
